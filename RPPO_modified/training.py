...
def main(cfg_file):
    ...
    # if use LSTM，adjust batch_size/n_steps
    if model_checkpoint == "0":
        # Initialize the agent (train from scratch)
        # 改用 RecurrentPPO + MultiInputLstmPolicy
        agent = RecurrentPPO(
            ...
            ent_coef=params["ppo_settings"].get("ent_coef", 0.0),
        )
    else:
