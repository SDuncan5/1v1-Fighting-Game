...
def main(use_controller):
    ...
    settings.disable_keyboard = False  # ADDED
    ...
    recording_settings.dataset_path = os.path.join(
        home_dir, "DIAMBRA/episode_recording", game_id if use_controller else "mock"
    )
    recording_settings.username = "sdunkan"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Flag to activate use of controller",
    )
