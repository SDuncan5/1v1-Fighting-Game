...
Usage:
diambra run -r "$PWD/roms/" python super_cool_eval_script.py --cfgFile "$PWD/cfg_files/sfiii3n/sr6_128x4_das_nc_A2C.yaml" --trainedModel "$PWD/results/sfiii3n/sr6_128x4_das_nc_A2C/model/0_autosave_3700000.zip"
"""
